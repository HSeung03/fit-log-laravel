                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    @forelse($logs as $log)
                        <a href="{{ route('logs.show', $log->record_date->format('Y-m-d')) }}" 
                           class="group block p-6 bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md hover:border-blue-300 transition-all duration-200">
                            <div class="flex justify-between items-center">
                                <div>
                                    <span class="text-sm text-blue-500 font-semibold uppercase tracking-wider"></span>
                    ...
                    @empty
                        <div class="col-span-full text-center py-12">
                            ...
                            <a href="{{ route('home') }}" class="mt-4 inline-block text-blue-600 hover:underline">첫 기록 등록하러 가기</a>
                        </div>
                    @endforelse
                </div>
